<?php
use App\Http\Controllers\tutor\HomeController;
...
Route::get('home','tutor\HomeController@index');
...
Route::get('/view','tutor\HomeController@create');

Route::get('check', 'tutor\HomeController@show');

foreach(glob(__DIR__.'/module/*') as $filter_routes):
    (basename($filter_routes == 'routes.php'))? :require_once($filter_routes);
endforeach;
